...
gawk cpio bzip2 xz zip unzip lzip lunzip lzo lzop lz4 file groff gdbm libpipeline man-db ed bc patch \
pcre swig libffi openssl nghttp2 curl elfutils Python2 Python libxml2 libiconv glib pkg-config \
