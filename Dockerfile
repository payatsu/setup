...
elfutils bison binutils flex libtool less texinfo gawk pcre libiconv glib \
...
json fmt spdlog cares re2 protobuf abseil grpc Bear ccache libyaml ruby libatomic_ops \
gc gperf guile boost source-highlight util-linux popt babeltrace gdb make autogen \
openssh go rustc zsh bash screen libevent tmux lua vim neovim global the_silver_searcher \
the_platinum_searcher highway ripgrep fzf jq rsync dtc strace sysstat procps systemtap \
